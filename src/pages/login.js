    ...
    <div class="w-full max-w-md">
      <div class="card p-8 shadow-xl border-0" style="border-radius: 28px;">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center size-16 bg-primary/10 text-primary rounded-2xl mb-4">
            <span class="material-symbols-outlined text-3xl">tune</span>
          </div>
          <h2 class="text-2xl font-black text-slate-900">Meta Automation</h2>
        ...
        <form id="login-form">
          ...
          <div class="mb-5">
            <div class="flex justify-between items-center mb-2">
              ...
              <a href="#/forgot-password" class="text-xs font-bold text-primary hover:underline">Lupa Password?</a>
            </div>
            <div class="input-group">
          ...
          <div class="mb-6 flex items-center gap-2">
            <input type="checkbox" id="remember" class="rounded border-slate-300 text-primary focus:ring-primary/30" />
        ...
        <div class="grid grid-cols-2 gap-3">
          <button class="btn-outline justify-center py-3">
        ...
        <p class="text-center text-sm text-slate-500 mt-6">
          Belum memiliki akun? <a href="#/register" class="text-primary font-bold hover:underline">Daftar sekarang</a>
        </p>
      </div>

      <!-- Footer -->
      <div class="mt-6 text-center">
        <div class="flex items-center justify-center gap-3 text-xs text-slate-400 font-bold uppercase tracking-wider">
          <a href="#" class="hover:text-primary">Bantuan</a>
          <span>·</span>
          <a href="#" class="hover:text-primary">Privasi</a>
          <span>·</span>
          <a href="#" class="hover:text-primary">Syarat</a>
        </div>
        <p class="text-xs text-slate-400 mt-3">© 2024 Meta Automation System. Seluruh hak cipta dilindungi.</p>
      </div>
    </div>
  </div>`;
